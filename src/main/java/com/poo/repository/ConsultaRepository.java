...
public class ConsultaRepository
{
    ...
    public Consulta create(Consulta consulta) throws SQLException, IllegalArgumentException
    {
        if (consulta != null && !ValidadorUtils.isHorarioValido(consulta.getHorario())) {
            throw new IllegalArgumentException("Impossível persistir: o horário da consulta é inválido.");
        }
        try
        {
    ...
    public void update(Consulta consulta) throws SQLException, IllegalArgumentException
    {
        if (consulta != null && !ValidadorUtils.isHorarioValido(consulta.getHorario())) {
            throw new IllegalArgumentException("Impossível atualizar: o horário da consulta é inválido.");
        }
        try
        {
            dao.update(consulta);
